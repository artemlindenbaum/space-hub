...
import 'package:space_hub/shared/ui/space_button.dart';
      ...
      child: BlocBuilder<AuthCubit, AuthState>(
        builder: (context, state) {
          return SpaceScaffold(
            body: Stack(
              children: [
                Center(child: SvgPicture.asset(Assets.icons.svg.bgTruck.path)),
                Center(
                  child: Padding(
                    padding: EdgeInsets.only(bottom: context.sh * 0.25),
                    child: SvgPicture.asset(Assets.icons.svg.mainTruck.path),
                  ),
                ),
                Positioned(
                  left: 10,
